...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="新闻类型" prop="xinwenleixing">
            <el-select v-model="ruleForm.xinwenleixing" placeholder="请选择新闻类型"  >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="来自" prop="laizi">
            <el-input v-model="ruleForm.laizi" 
                placeholder="来自" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="跟帖" prop="gentie">
            <el-input v-model="ruleForm.gentie" 
                placeholder="跟帖" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="关键字" prop="guanjianzi">
            <el-input v-model="ruleForm.guanjianzi" 
                placeholder="关键字" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="内容" prop="detail">
            <editor 
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='laizi'){
              this.ruleForm.laizi = obj[o];
              this.ro.laizi = true;
              continue;
            }
            if(o=='gentie'){
              this.ruleForm.gentie = obj[o];
              this.ro.gentie = true;
              continue;
            }
            if(o=='guanjianzi'){
              this.ruleForm.guanjianzi = obj[o];
              this.ro.guanjianzi = true;
              continue;
            }
            if(o=='fabushijian'){
        ...
        this.$http.get('option/xinwenleixing/xinwenleixing', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
