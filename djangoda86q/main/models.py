...
class xinwenzixun(BaseModel):
    __doc__ = u'''xinwenzixun'''
    __tablename__ = 'xinwenzixun'
    ...
    xinwenleixing=models.CharField ( max_length=255, null=True, unique=False, verbose_name='新闻类型' )
    laizi=models.CharField ( max_length=255, null=True, unique=False, verbose_name='来自' )
    gentie=models.CharField ( max_length=255, null=True, unique=False, verbose_name='跟帖' )
    guanjianzi=models.CharField ( max_length=255, null=True, unique=False, verbose_name='关键字' )
    fabushijian=models.CharField ( max_length=255, null=True, unique=False, verbose_name='发布时间' )
    detail=models.TextField   (  null=True, unique=False, verbose_name='内容' )
    ...
    '''
    class Meta:
        db_table = 'xinwenzixun'
        verbose_name = verbose_name_plural = '新闻资讯'
class xinwenleixing(BaseModel):
    ...
    '''
    class Meta:
        db_table = 'xinwenleixing'
        verbose_name = verbose_name_plural = '新闻类型'
class wangyixinwen(BaseModel):
    __doc__ = u'''wangyixinwen'''
    __tablename__ = 'wangyixinwen'
    ...
    fengmian=models.TextField   (  null=True, unique=False, verbose_name='封面' )
    laizi=models.CharField ( max_length=255, null=True, unique=False, verbose_name='来自' )
    gentie=models.IntegerField  (  null=True, unique=False, verbose_name='跟帖' )
    guanjianzi=models.CharField ( max_length=255, null=True, unique=False, verbose_name='关键字' )
    fabushijian=models.CharField ( max_length=255, null=True, unique=False, verbose_name='发布时间' )
    detail=models.TextField   (  null=True, unique=False, verbose_name='内容' )
    clicktime=models.DateTimeField  (  null=True, unique=False, verbose_name='最近点击时间' )
    ...
    '''
    class Meta:
        db_table = 'wangyixinwen'
        verbose_name = verbose_name_plural = '网易新闻'
...
class systemintro(BaseModel):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = '关于我们'
class discussxinwenzixun(BaseModel):
    __doc__ = u'''discussxinwenzixun'''
    __tablename__ = 'discussxinwenzixun'
    ...
    '''
    class Meta:
        db_table = 'discussxinwenzixun'
        verbose_name = verbose_name_plural = '新闻资讯评论表'
class discusswangyixinwen(BaseModel):
    __doc__ = u'''discusswangyixinwen'''
    __tablename__ = 'discusswangyixinwen'
    ...
    '''
    class Meta:
        db_table = 'discusswangyixinwen'
        verbose_name = verbose_name_plural = 'wangyixinwen评论表'
